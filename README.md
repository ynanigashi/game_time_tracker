...
- モジュール構成:
  ...
  - `src/app`: エントリーポイント/UI制御（`main.py`, `controllers/`, `session_state.py`, `alert_state.py`, `display_state.py`, `dialog_state.py`, `window_title_state.py`, `lifecycle_state.py`, `tray_state.py`, `cover_detector.py`, `overlay_window.py`, `display_modes.py`）
