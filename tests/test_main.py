...
class TestOverlayMethods(unittest.TestCase):
    ...
    def test_overlay_drag_handle_hit_test_uses_native_window_rect(self):
        ...
        with patch("src.app.main_components.sys.platform", "win32"), patch.object(
            overlay,
            "_native_window_rect",
    ...
    def test_overlay_drag_continues_from_global_cursor_when_mouse_move_is_missing(self):
        ...
        with patch.object(main.components.QCursor, "pos", return_value=point), patch.object(
            overlay,
        ...
        with patch("src.app.main_components.sys.platform", "win32"), patch.object(
            ...
            overlay._handle_native_overlay_event(
                self._win_msg_address(
                    main.components.WM_MOUSEMOVE,
                    main.components.MK_LBUTTON,
                )
            )
            overlay._handle_native_overlay_event(
                self._win_msg_address(main.components.WM_LBUTTONUP, 0)
            )
